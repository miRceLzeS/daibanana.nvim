...
function M.load()
  ...
  local highlights        = {
    ...
    ["@lsp.type.namespace"]                  = { fg = p.fg_soft },
    ...
    ["@lsp.typemod.function.defaultLibrary"] = { fg = p.gold, italic = true },
    ["@lsp.typemod.method.defaultLibrary"]   = { fg = p.gold, italic = true },
    ["@lsp.typemod.variable.defaultLibrary"] = { fg = p.fg, italic = true },
    ["@lsp.typemod.property.defaultLibrary"] = { fg = p.fg, italic = true },
    ["@lsp.typemod.class.defaultLibrary"]    = { fg = p.blue, italic = true },
